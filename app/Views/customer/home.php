...
<head>
    ...
    <meta name="description" content="Customer Homepage">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url('/') ?>">Tiara Brand</a>
    ...
    <!-- Bootstrap JS -->
    <script src="<?= base_url('../public/bootstrap-5.2.3/js/bootstrap.bundle.min.js') ?>"></script>
</body>
</html>
